      ...
      <Html center style={{ zIndex: isActive ? 1000 : 10 }}>
        {!isActive ? (
          ...
          <button
            ...
            className="group flex items-center space-x-1.5 px-2 py-0.5 rounded-full bg-white/95 backdrop-blur-md border border-red-500/60 text-slate-800 hover:border-ink-700 hover:bg-slate-50 shadow-md shadow-red-500/10 transition-colors duration-150 cursor-pointer select-none"
          >
            <span className="relative flex h-2 w-2 shrink-0">
              <span className="absolute inline-flex h-full w-full rounded-full bg-red-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-red-600"></span>
            </span>
            <span className="text-label font-mono font-bold text-slate-850 whitespace-nowrap">
              {beaconLabel}
            </span>
          </button>
        ) : (
          ...
          <div
            ...
            className="w-64 glass-panel p-3 rounded border-red-400 shadow-2xl text-slate-800 text-xs font-sans pointer-events-auto select-none animate-in fade-in zoom-in-95 duration-150 relative z-50"
          >
            {/* Header */}
            ...
            {type === 'shm' && subsystems?.shm && (
              <div className="space-y-1.5 font-mono text-label">
                ...
                <div className="bg-slate-50 p-1.5 rounded border border-slate-200/70 flex justify-between items-center">
            ...
            <div className="mt-2.5 pt-2 border-t border-black/5 flex items-center justify-between">
              <button
                ...
                className="w-full py-1.5 px-2.5 rounded bg-ink-900 hover:bg-ink-700 text-white font-mono text-label font-bold flex items-center justify-center space-x-1 transition-colors duration-150 shadow-md shadow-red-600/30"
              >
